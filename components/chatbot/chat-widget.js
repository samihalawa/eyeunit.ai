export class ChatWidget {
    ...
    createWidget() {
        ...
        window.addEventListener('resize', () => {
            ...
            // If device type changed and chat is open, adjust the UI
            if (wasMobile !== this.isMobile && this.isOpen) {
                const chatContainer = document.querySelector('.chat-container');
                if (chatContainer) {
                    if (this.isMobile) {
                        // Switched to mobile while open
                        document.body.style.overflow = 'hidden'; // Prevent scrolling behind the chat
                    } else {
                        // Switched to desktop while open
    ...
    attachEventListeners() {
        ...
        chatIcon.addEventListener('touchstart', (e) => {
            e.preventDefault(); // Prevent double-tap zooming
            this.toggleChat();
        });
        ...
        // Send message on Enter key press (except on mobile with shift key)
        ...
        // Add touchstart for send button
    ...
    toggleChat() {
        ...
        if (this.isOpen) {
            ...
            // If on mobile, prevent body scrolling
            if (this.isMobile) {
